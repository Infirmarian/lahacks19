...
class SearchAddress extends React.Component {
    constructor(props) {
        ...
        this.storeCoords = this.storeCoords.bind(this);
    }
    ...
    handleSubmit() {
        ...
        .then(latLng => console.log('Success', latLng.lat, latLng.lng))//{ this.storeCoords(latLng) })//this.setState({lat: latLng.lat, long: latLng.long}) })
    ...
    storeCoords(loc) {
        this.setState({lat: loc.lat, long: loc.long});
    }
        ...
        return (
            <div id="parent">
              ...
              <form type="text">
                    ...
                    <Link to={"/map/" + this.state.lat + "-" + this.state.long}><button id="submit" onClick={this.handleSubmit}>Search</button></Link>
                </form>
              </div>
            </div>
